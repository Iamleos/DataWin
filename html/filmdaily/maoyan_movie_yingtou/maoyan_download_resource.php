<?php
  ...
  $filmname = $filmname[1];
  $filmnum = $filmnum[1];
  $file = fopen("/var/www/html/filmdaily/maoyan_movie_yingtou/filmname.txt","w");
  ...
  /*
  var_dump($ttf);
  $file = fopen('/var/www/html/filmdaily/maoyanfen/result.txt','w');
  fwrite($file, $result);
  $com = "wget -P /var/www/html/filmdaily/maoyanfen ".$ttf[1][0];
  shell_exec($com);
  sleep(3);
  shell_exec('rename '.$filename[1][0].' map.ttf /var/www/html/filmdaily/maoyanfen/'.$filename[1][0]);
  sleep(3);
  shell_exec("java -classpath /var/www/html/filmdaily/maoyanfen maoyan");
  die();
  sleep(3);
  shell_exec("php /var/www/html/filmdaily/maoyanfen/maoyan_getData.php");
*/
 ?>
