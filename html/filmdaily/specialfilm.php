 ...
 */
 #! /usr/bin/php
   ...
   //$password="123456";
	...
	mysql_query("drop table if exists specialfilm",$con);
    mysql_query("create table specialfilm(mname varchar(30),type int(8),macquitime date,primary key(mname,macquitime));",$con);
	...
	for($i=0;$i<$size;$i++)
	{
		...
		$sqlinsert="insert into specialfilm(mname,type,macquitime) values('{$name}','{$type}','{$day}')";
        echo $sqlinsert."<br/>";
