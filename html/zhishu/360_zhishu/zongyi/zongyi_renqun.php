...
#    $characters = json_decode(json_encode($characters),true);
    ...
    $zongyi = mysqli_query($con, "select name from linshi_word");
    $zongyi = mysqli_fetch_all($zongyi);
    mysqli_close($con);
    //入库
    $host="56a3768226622.sh.cdb.myqcloud.com";
    $name="root";
    ...
    foreach ($zongyi as $key => $value) {
        ...
        do {
            $json = NULL;
            $data = NULL;
            exec("python /var/www/html/zhishu/360_zhishu/python/getData_renqun.py '{$zongyiname}'",$json);
        ...
        mysqli_query($con,"insert into 360_zongyi_region(name,
        ...
        mysqli_query($con, "insert into 360_zongyi_renqun values('{$zongyiname}',
        ...
        mysqli_query($con, "insert into 360_zongyi_attribute values('{$zongyiname}',
        ...
        '{$date}');");
        var_dump("insert into 360_zongyi_attribute values('{$zongyiname}',
        '{$interest[0]->entity}','{$interest[0]->percent}','{$interest[1]->entity}','{$interest[1]->percent}',
        '{$interest[2]->entity}','{$interest[2]->percent}','{$interest[3]->entity}','{$interest[3]->percent}',
        '{$interest[4]->entity}','{$interest[4]->percent}','{$interest[5]->entity}','{$interest[5]->percent}',
        '{$interest[6]->entity}','{$interest[6]->percent}','{$interest[7]->entity}','{$interest[7]->percent}',
