...
#    $characters = json_decode(json_encode($characters),true);
    ...
    foreach ($yiren as $key => $value) {
        ...
        do {
            $json = NULL;
            $data = NULL;
            exec("python /var/www/html/zhishu/360_zhishu/python/getData_renqun.py '{$yirenname}'",$json);
        ...
        mysqli_query($con,"insert into 360_yiren_region(name,
        ...
        mysqli_query($con, "insert into 360_yiren_renqun values('{$yirenname}',
        ...
        mysqli_query($con, "insert into 360_yiren_attribute values('{$yirenname}',
        ...
        '{$date}');");
        var_dump("insert into 360_yiren_attribute values('{$yirenname}',
        '{$interest[0]->entity}','{$interest[0]->percent}','{$interest[1]->entity}','{$interest[1]->percent}',
        '{$interest[2]->entity}','{$interest[2]->percent}','{$interest[3]->entity}','{$interest[3]->percent}',
        '{$interest[4]->entity}','{$interest[4]->percent}','{$interest[5]->entity}','{$interest[5]->percent}',
        '{$interest[6]->entity}','{$interest[6]->percent}','{$interest[7]->entity}','{$interest[7]->percent}',
